...
const LogoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 160 159' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <circle cx={80} cy={79.5} r={79.5} fill='url(#paint0_linear_5672_639254)' />
    <path
      fillRule='evenodd'
      clipRule='evenodd'
      ...
      fill='url(#paint1_linear_5672_639254)'
    />
    <path
      ...
      fill='url(#paint2_linear_5672_639254)'
    />
    <path
      ...
      fill='url(#paint3_linear_5672_639254)'
    />
    <path
      ...
      fill='url(#paint4_linear_5672_639254)'
    />
    <defs>
      <linearGradient id='paint0_linear_5672_639254' x1={80} y1={0} x2={80} y2={159} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#00EFFF' />
        <stop offset={1} stopColor='#26106F' stopOpacity={0} />
      </linearGradient>
      <linearGradient
        id='paint1_linear_5672_639254'
        x1={79.5}
        y1={35}
        x2={79.5}
        y2={124}
